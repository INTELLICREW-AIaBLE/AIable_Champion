      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shrink-0 sticky top-0 h-screen shadow-sm">
        <div className="h-16 flex items-center px-6 border-b border-slate-100">
          <Link href="/admin/dashboard" className="flex items-center gap-2.5">
            <Image src="/logo.png" alt="AIaBLE Logo" width={32} height={32} priority className="rounded-lg shadow-sm" />
            <span className="text-lg font-black text-slate-900 tracking-tight">AIaBLE Admin</span>
          </Link>
        </div>
